...
async function handleSetupWildcard(ctx) {
    ...
    try {
        ...
        const spinners = {
            dots: { frames: ['⠋', '⠙', '⠹', '⠸', '⠼', '⠴', '⠦', '⠧', '⠇', '⠏'], name: 'Classic Dots' },
            circle: { frames: ['◐', '◓', '◑', '◒'], name: 'Circle Rotation' },
            arrows: { frames: ['←', '↖', '↑', '↗', '→', '↘', '↓', '↙'], name: 'Arrow Direction' },
            bounce: { frames: ['⠁', '⠂', '⠄', '⠂'], name: 'Bounce Effect' },
            pulseDot: { frames: ['⣾', '⣽', '⣻', '⢿', '⡿', '⣟', '⣯', '⣷'], name: 'Pulse Dot' },
            growVertical: { frames: ['▁', '▃', '▄', '▅', '▆', '▇', '█', '▇', '▆', '▅', '▄', '▃'], name: 'Grow Vertical' },
            growHorizontal: { frames: ['▏', '▎', '▍', '▌', '▋', '▊', '▉', '█', '▉', '▊', '▋', '▌', '▍', '▎'], name: 'Grow Horizontal' },
            clock: { frames: ['🕐', '🕑', '🕒', '🕓', '🕔', '🕕', '🕖', '🕗', '🕘', '🕙', '🕚', '🕛'], name: 'Clock Animation' },
            moon: { frames: ['🌑', '🌒', '🌓', '🌔', '🌕', '🌖', '🌗', '🌘'], name: 'Moon Phases' },
            weather: { frames: ['☀️', '🌤', '⛅', '🌥', '☁️', '🌦', '🌧', '⛈', '🌩', '🌨'], name: 'Weather Cycle' }
        };
        ...
        if (result.success) {
            ...
            const successMessage = '✨ **WILDCARD SETUP COMPLETE!** ✨\n\n' +
                '🌟 **Domain Terdaftar**\n' + 
                '┌──────────────────\n' +
                '│ 🔰 **Domain:** `' + domain + '`\n' +
                '│ 🎯 **Type:** Wildcard DNS\n' +
                ...
                '🚀 **Panduan Penggunaan**\n' +
                '┌──────────────────\n' +
                '│ • Semua Wildcard `*.' + domain + '` aktif\n' +
                '│ • Contoh: `support.zoom.us.' + domain + '`\n' +
                '└──────────────────\n\n' +
                '⚡ **Quick Actions**\n' +
