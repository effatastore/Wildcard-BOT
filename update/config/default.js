...
const FORBIDDEN_KEYWORDS = [
    'admin', 'root', 'www', 'mail', 'ftp', 'ssh',
    'api', 'test', 'dev', 'staging', 'prod',
    'porn', 'xxx', 'adult', 'sex', 'gambling'
];
...
module.exports = {
    ...
    NOTIFICATIONS: {
        TELEGRAM_GROUP_ID: process.env.TELEGRAM_GROUP_ID || '', // ID grup Telegram untuk notifikasi
        
        WHATSAPP: {
            enabled: true,
            apiUrl: 'https://app.wapanels.com/api/create-message',
            appkey: 'cffce33f-bb0d-4789-86d1-7f057d8a49ae', // Update jika perlu
            authkey: 'ek1wMPnk958lF7Xk57MFsAebB8mpgXVFwINDvOCjD1EomkHFXc', // Update jika perlu
            to: '62882001492789' // Pastikan nomor ini aktif dan terverifikasi
        }
    }
}; 